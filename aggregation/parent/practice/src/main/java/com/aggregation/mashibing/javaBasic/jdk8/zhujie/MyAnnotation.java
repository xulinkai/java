package com.aggregation.mashibing.javaBasic.jdk8.zhujie;
 ...
 * @Documented public @interface FirstAnnotation {
 * }
 * <p>
 * //等效于@FirstAnnotation()
 * @FirstAnnotation public class JavaBean{
 * //省略实现部分
 * }
 * <p>
 ...
 * @Retention(RetentionPolicy.RUNTIME)
 * @Target(value = {ElementType.TYPE})
 * @Documented public @interface SecondAnnotation {
 * String value();
 * }
 * <p>
 ...
 * @Retention(RetentionPolicy.RUNTIME)
 * @Target(value = {ElementType.TYPE})
 * @Documented public @interface ThirdAnnotation {
 * String[] name();
 * }
 * <p>
