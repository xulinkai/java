package com.aggregation.redis.aop;

import com.aggregation.common.enums.redis.RedisLockTypeEnum;
import com.aggregation.redis.annotation.RedisLockAnnotation;
import com.aggregation.redis.model.RedisLockDefinitionHolder;
...
public class RedisLockAspect {
    ...
    @Pointcut("@annotation(com.aggregation.redis.annotation.RedisLockAnnotation)")
     ...
     * @return
     */
    private static Method getMethod(ProceedingJoinPoint pjp) throws Exception {
