...
abstract class ConfigurationClassUtils {
	 ...
	 */
	/**
	 * @Desc 检查给定的bean定义是否为配置类(或在configurationcomponent类中声明的嵌套组件类，也将自动注册)的候选对象，并相应地标记它。
	 */
	 ...
	 */
	/**
	 * @Desc 检查给定元数据中配置类候选(或在configurationcomponent类中声明的嵌套组件类)。
	 */
